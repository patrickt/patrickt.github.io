...
Let's get started. This post is literate Haskell; you can find its source here. We'll call this little web app ~Quad~, in homage to [[https://en.wikipedia.org/wiki/86-DOS][another]] quick-and-dirty software product of yesteryear.
